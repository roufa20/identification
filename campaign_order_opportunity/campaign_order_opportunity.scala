...
object campaign_order_opportunity_From_Kafka_To_Spark {
  ...
  /**
    ...
    * @return
    */
  def identified_Campaign_order_opportunity(csvContainer: String, broockers: String, TOPIC: String): Int = {
        ...
        val result = rdd.foreachPartition { partitionOfRecords =>
          ...
          partitionOfRecords.foreach { pair =>
            ...
            for (x <- 0 to dataArray.length - 1) {
              ...
              identified_Campaign_order_opportunity(csvToSend, args(3), args(5));
