...
object CampaignFromKafkaToSpark {
  ...
  /**
    ...
    * @return
    */
  def identifiedCampaign(csvContainer: String, broockers: String, TOPIC: String): Int = {
        ...
        val result = rdd.foreachPartition { partitionOfRecords =>
          ...
          partitionOfRecords.foreach { pair =>
              ...
              for (x <- 0 to dataArray.length - 1) {
                ...
                var metaContainerSingle = new JSONObject(metaContainer)//metaList
               ...
               identifiedCampaign(csvToSend,args(3),args(5));
